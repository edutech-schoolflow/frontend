...
const NAV = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Blog", href: "#" },
      { label: "Careers", href: "#" },
      { label: "Contact", href: "mailto:hello@oneschoolplatform.com" },
    ],
  },
  {
    heading: "Legal",
...
export default function Footer() {
  return (
    <footer className="w-full bg-brand-green-dark px-8 pt-16 pb-8 md:px-12 lg:px-20 xl:px-28">
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr_1fr_1fr]">
          ...
          {NAV.map((col) => (
            <div key={col.heading} className="flex flex-col gap-4">
              <h4 className="text-[13px] font-semibold uppercase tracking-widest text-white/40">
                {col.heading}
              </h4>
        ...
        <div className="mt-14 border-t border-white/10 pt-6">
          <div className="flex flex-col items-center justify-between gap-3 text-[13px] text-white/40 md:flex-row">
            <span>
              © {new Date().getFullYear()} Oneschoolplatform. All rights
              reserved.
            </span>
            <span>Made with care for Nigerian schools</span>
          </div>
        </div>
      </div>
    </footer>
