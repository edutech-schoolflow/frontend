...
export default function ParentForgotPassword() {
  ...
  const onSubmitPhone = async (values: Values) => {
  ...
  const handleContinue = async () => {
    ...
    setSubmitting(true);
    try {
      await verifyForgotPasswordOtp({ phone: sentPhone, otp });
      setModal("success");
    } catch {
      setModal("error");
    } finally {
  ...
  const handleResend = async () => {
    setResending(true);
    try {
      await forgotPassword(sentPhone);
      setCountdown(RESEND_SECONDS);
      setOtp("");
    } finally {
      setResending(false);
    ...
    <>
      {modal === "success" && (
        <OtpResultModal
          ...
          onAction={() => router.push("/parent/reset-password")}
        />
      )}
              ...
              <div className="flex flex-col gap-[45px]">
                <div className="flex flex-col gap-[18px]">
                  ...
                  <p className="text-[14px] font-normal text-[#666]">
                    Enter your phone number and we&apos;ll send you a code to
                    reset your password.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-[48px]">
                  <div className="flex flex-col gap-[18px]">
                    ...
                    <p className="text-[16px] font-medium text-[#1b1b1b]">
                      ...
                      <span className="text-brand-green">{sentPhone}</span>.
                      Enter it below.
                    </p>
                  </div>
