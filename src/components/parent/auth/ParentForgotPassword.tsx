...
type Values = z.infer<typeof parentForgotPasswordSchema>;
...
export default function ParentForgotPassword() {
  ...
  const form = useForm<Values>({
    resolver: zodResolver(parentForgotPasswordSchema),
    mode: "onTouched",
    defaultValues: { phone: "" },
  });
  ...
  const onSubmit = async (values: Values) => {
    try {
      const message = await forgotParentPassword(values.phone);
